      ...
      child: ListView(
        children:[
          DrawerHeader( padding:EdgeInsets.zero,
            ...
            accountName:Text("Gaurav chandel"),
            accountEmail:Text("mrchandel64@gmail.com"),
          ...
          ListTile(
            ...
            title: Text(
              "Profile",textScaleFactor: 1.2 ,style: TextStyle(color:Colors.white,),
            ),
          ...
          ListTile(
            ...
            title: Text(
              "Email me",textScaleFactor: 1.2 ,style: TextStyle(color:Colors.white,),
            ),
